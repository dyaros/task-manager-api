...
router.patch('/users/me', auth, async (req, res) => {
    // Provide user information if the operation is not valid
    ...
    try {
        ...
        // Failed validation. There could be some 500 errors. Not coding for that
        res.status(400).send()
    }
})
...
//console.log(user.avatar)
        ...
        // set header. Express automatically sets it to application/json
